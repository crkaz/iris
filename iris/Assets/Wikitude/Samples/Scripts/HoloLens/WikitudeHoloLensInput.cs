...
{
    /*
     * WikitudeHoloLensInput is a copy of the native HoloLensInput.
     * The Wikitude HoloLens Plugin supports Unity starting with version 2017.4, where the HoloLensInput is part of the base Unity installation,
     * up to version 2018.3, where the HoloLensInput is part of the WindowsMixedReality package. To support both these version, as well as everything in between, 
     ...
     */
    public class WikitudeHoloLensInput : BaseInput
    {
        ///////////////
        // BaseInput //
        ///////////////
        ...
        protected override void Awake()
        {
            ...
            m_Module = GetComponent<WikitudeHoloLensInputModule>();
        ...
        private WikitudeHoloLensInputModule m_Module;
